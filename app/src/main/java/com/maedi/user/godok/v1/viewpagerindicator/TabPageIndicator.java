 ...
 */
package com.maedi.user.godok.v1.viewpagerindicator;
...
public class TabPageIndicator extends HorizontalScrollView implements PageIndicator {
    ...
    private void addTab(int index, CharSequence text, int iconResId) {
        ...
        tabView.setPadding(
                0,
                DataScreenSize.PixelToDP(getContext(),Integer.parseInt(getResources().getString(R.string.tab_button_padding_top))),
                0,
                DataScreenSize.PixelToDP(getContext(),Integer.parseInt(getResources().getString(R.string.tab_button_padding_bottom))));
    ...
    /////////////////////////////////////////////////////////////////
    @Override
    public void setCurrentItem(int item, String title) {
        if (mViewPager == null) {
            throw new IllegalStateException("ViewPager has not been bound.");
        }
        mSelectedTabIndex = item;
        mViewPager.setCurrentItem(item);
        changeTabLayout(item, title);
    ...
    private void changeTabLayout(int item, String title){
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if(i == 1) child.setBackgroundResource(R.drawable.tab_view);//child.setPadding(0, 0, 10, 0);//L,T,R,B
