...
public class ListDataPointResultAdapter extends ArrayAdapter<ListMenu> {
    ...
    public ListDataPointResultAdapter(Context context, int layoutResourceId, ListMenu data, String tag) {
