...
public class ListDataDoctorAdapter extends ArrayAdapter<ListMenu> {
    ...
    public ListDataDoctorAdapter(Context context, FragmentActivity f, int layoutResourceId, ListMenu data, String tag) {
            ...
            public void onClick(View v) {
                ...
                Runnable mPendingRunnable = new Runnable() {
                    ...
                    public void run() {
                        ...
                        Fragment fragment = ChatUserFragment.newInstance(lm.text, "doctor");
