...
package com.maedi.user.godok.v1.viewpagerindicator.imbryk;
...
public class LoopViewPager extends ViewPager {
    ...
    private OnPageChangeListener onPageChangeListener = new OnPageChangeListener() {
        ...
        public void onPageScrolled(int position, float positionOffset,
			...
			/////////////////////////////////////////////////////
			//THIS FOR ADJUST PAGE OpenShopActivity			   //
            //IF PageScrolled IS SCROLLED, WE MUST DISABLE	   //
			//SCROLL VERTICALLING							   //
			/////////////////////////////////////////////////////
		//	OpenShopActivity.sView.setScrollingEnabled(false);
			//android.util.Log.i("==OpenShopActivity==","false");
            if (mAdapter != null) {
        ...
        public void onPageScrollStateChanged(int state) {
            if (mAdapter != null) {
				...
				/////////////////////////////////////////////////////
				//THIS FOR ADJUST PAGE OpenShopActivity			   //
				//IF ViewPager.SCROLL_STATE_IDLE EXC, 			   //
				//WE MUST ENABLE AGAIN THE SCROLLING 			   //
				/////////////////////////////////////////////////////
			//	OpenShopActivity.sView.setScrollingEnabled(true);
				//android.util.Log.i("==OpenShopActivity==","true");
