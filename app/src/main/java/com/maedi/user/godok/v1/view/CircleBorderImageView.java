...
public class CircleBorderImageView extends ImageView
{
    ...
    public CircleBorderImageView(Context context, AttributeSet attrs, int defStyle)
    {
	...
	private void setup()
    {
        ...
        //setBorderColor(getContext().getResources().getColor(R.color.borderlayout_image)); 
