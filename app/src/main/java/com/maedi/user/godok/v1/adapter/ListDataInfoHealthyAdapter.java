...
public class ListDataInfoHealthyAdapter extends ArrayAdapter<ListMenu> {
    ...
    public ListDataInfoHealthyAdapter(Context context, FragmentActivity f, int layoutResourceId, ListMenu data, String title, String tag) {
            ...
            public void onClick(View v) {
                ...
                Runnable mPendingRunnable = new Runnable() {
                    ...
                    public void run() {
                        ...
                        Fragment fragment = ArticleContentFragment.newInstance(title, "healthy");
